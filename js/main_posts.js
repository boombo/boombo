...
disqus_config = function() {
  this.callbacks.onReady.push(function() { console.log('DISQUS onReady'); scroll();});
  this.callbacks.onNewComment.push(function() { console.log('DISQUS onNewComment'); scroll();});
